...
C     * PDMROF
     ...
     5     UMQ(ILG),CSTRCS(ILG),CSTRC(ILG),CSTRG(ILG),CSTRGS(ILG),
...
!Craig Thompson added call to watrof, june 2008.
     ...
     4                DELZW,ISAND,IG,ILG,IL1,IL2,JL,N,CSTRCS   )
...
!Craig Thompson added call to watrof, june 2008.
     ...
     4                DELZW,ISAND,IG,ILG,IL1,IL2,JL,N,CSTRGS   )
...
!Craig Thompson added call to watrof, june 2008.
     ...
     4                DELZW,ISAND,IG,ILG,IL1,IL2,JL,N,CSTRC    )
C
      ENDIF                                                               
C
...
!Craig Thompson added call to watrof, june 2008.
     ...
     4                DELZW,ISAND,IG,ILG,IL1,IL2,JL,N,CSTRG   )
C
      ENDIF
C
